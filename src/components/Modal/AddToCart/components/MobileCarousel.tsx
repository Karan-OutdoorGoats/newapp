  ...
  return (
    <div className="relative">
      <div className="relative overflow-clip">
        ...
        <div className="absolute top-[5%] left-[5%] z-[10]  bg-primaryColor text-white font-OG-Regular text-xs px-3 py-1">
          <p>40% OFF</p>
        </div>

        <div className="absolute bottom-[10%]  left-[32%]  origin-center rotate-[-33deg] z-[10]  bg-orange text-white font-OG-Regular text-[0.6rem] w-full py-[1px]">
