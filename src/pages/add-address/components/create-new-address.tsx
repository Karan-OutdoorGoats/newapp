...
const CreateNewAddress = (props: CreateAddressProps) => {
    ...
    <ReactModal
      ...
      style={{
        content: {
          ...
          height: screenSize.width > 600 ? "70vh" : "98dvh",
          overflowY: "scroll",
          ...
          <div>
            ...
            <div className="flex flex-row items-center gap-2">
              <InputBoxField
                id="default_billing"
                type="checkbox"
                className="items-center px-3 text-sm hover:cursor-pointer focus:outline-none font-OG-Regular checked:border-primaryColor checked:accent-primaryColor focus:accent-primaryColor"
              />
              <label
                htmlFor="default_billing"
                className="text-sm font-OG-Regular hover:cursor-pointer text-lightTextColor"
              >
            ...
            <div className="flex flex-row items-center gap-2">
              ...
              <label
                ...
                className="text-sm hover:cursor-pointer font-OG-Regular text-lightTextColor"
              >
