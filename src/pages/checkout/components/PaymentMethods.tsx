...
const PaymentMethods = () => {
  return (
    <div className="mx-4 my-2 sm:my-0 sm:mx-0">
      {/* <div className="sm:border-[1px]">
        <div className="flex flex-row items-center h-[48px] px-3 gap-3 bg-primaryColor">
          <FaTruck className="text-white" size={"1.4rem"} />
          <p className="text-base text-white uppercase font-OG-Bold">
            Shipping method
          </p>
        </div>

        <div className="flex flex-row items-center justify-between px-3 py-8">
          <div className="flex flex-row items-center gap-4">
            ...
            />
            <p className="text-s font-OG-Regular text-lightTextColor">₹0</p>
          </div>
          <p className="text-s font-OG-Regular text-lightTextColor">Free</p>
      ...
      {/* <div className="sm:border-b-[1px] my-8 "></div> */}
